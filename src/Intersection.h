...
private:
    ...
    // Task 6, add a member variable of type TrafficLight, this is used to call the simulate function, 
    // which in turn starts a new thread at each intersection, to check the status of light at that intersection
